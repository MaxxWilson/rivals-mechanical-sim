...
def create_inertia_analysis_plot(step_responses, final_inertia_est):
    ...
    for i, step_df in enumerate(step_responses):
        ...
        ax_accel.plot(step_df[COLUMN_MAP['time']], step_df['acceleration_rad_s2'], color='orange', **line_plot_style)
        ax_torque.plot(step_df[COLUMN_MAP['time']], step_df['ideal_torque'], color='lime', **line_plot_style)
